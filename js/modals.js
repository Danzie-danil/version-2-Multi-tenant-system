    ...
    switch (type) {
        ...
        <div class="p-6">
            ...
            <form onsubmit="handleAddSale(event)" class="space-y-4">
                ...
                <div>
                    <label for="saleCustomerAddress" class="block text-sm font-medium text-gray-700 mb-1">Customer Address</label>
                    <textarea id="saleCustomerAddress" class="form-input" rows="2" placeholder="Customer address..."></textarea>
                </div>
        ...
        <div class="p-6">
            ...
            <form onsubmit="handleAddCustomer(event)" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="customerAddress" class="form-input" rows="2" placeholder="Enter customer address"></textarea>
                </div>
                <div class="flex gap-3 pt-2">
                    <button type="button" onclick="closeModal()" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 text-sm">Cancel</button>
        ...
        <div class="p-6">
            ...
            <form onsubmit="handleCreateQuotation(event)" class="space-y-4">
                ...
                <div>
                    <label for="quoteCustomerAddressOverride" class="block text-sm font-medium text-gray-700 mb-1">Customer Address</label>
...
window.handleAddSale = async function (e) {
    ...
    try {
        ...
        const customer_address = document.getElementById('saleCustomerAddress').value || null;
        ...
        await dbSales.add(state.branchId, { customer, items, amount, payment, productId, qty, customer_address });
        closeModal();
...
window.handleAddCustomer = async function (e) {
    ...
    try {
        ...
        await dbCustomers.add(state.branchId, { name, phone, email, address });
        closeModal();
