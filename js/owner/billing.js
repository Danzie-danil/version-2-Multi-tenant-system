...
window.renderOwnerBilling = async function () {
...
window.initiateSnippeCheckout = async function (planId, planName, planPrice) {
...
window.simulateSnippePaymentSuccess = async function (planId, mrrAmount) {
